    ...
    private void getAutoComplete(CharSequence constraint){
      ...
      /*  AutocompleteSessionToken token = AutocompleteSessionToken.newInstance();
        ...
        FindAutocompletePredictionsRequest request = FindAutocompletePredictionsRequest.builder()
                .setTypeFilter(TypeFilter.valueOf(PlaceTypes.ADDRESS))
        ...
        placesClient.findAutocompletePredictions(request).addOnSuccessListener((response) -> {
            for (AutocompletePrediction prediction : response.getAutocompletePredictions()) {
                Log.i(TAG,"id"+ prediction.getPlaceId());
                Log.i(TAG, "primary"+prediction.getPrimaryText(null).toString());
                Log.i(TAG, "second"+prediction.getSecondaryText(null).toString());
